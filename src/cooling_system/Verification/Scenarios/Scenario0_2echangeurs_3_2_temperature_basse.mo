...
model Scenario0_2echangeurs_3_2_temperature_basse
  extends Init.Scenario_init;
  Events.RemoveClient removeClient(power = 25E6, at = 200)  annotation(
    Placement(transformation(origin = {-164, 16}, extent = {{-10, -10}, {10, 10}})));
equation
  ...
  connect(HotPower_init.y, removeClient.inputReal) annotation(
    Line(points = {{-178, 16}, {-174, 16}}, color = {0, 0, 255}));
  connect(removeClient.outputReal, toConnector.load) annotation(
    Line(points = {{-154, 16}, {32, 16}, {32, -26}}, color = {0, 0, 255}));
end Scenario0_2echangeurs_3_2_temperature_basse;
