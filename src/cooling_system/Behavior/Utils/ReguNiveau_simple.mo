...
block ReguNiveau_simple "Régulation de niveau du SRI N4"
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.OutputLogical yvanne
    annotation (Placement(transformation(extent={{300,-230},{320,-210}},
          rotation=0)));
  BFE.Logique.HOP HOP1 annotation (Placement(transformation(extent={{40,-20},{
            80,20}}, rotation=0)));
  ...
  cooling_system.Behavior.Utils.ST.CapteurNiveau STCapteurNiveauMax2(
    seuil=niveauMax2,
    repere="1201 SN1",
