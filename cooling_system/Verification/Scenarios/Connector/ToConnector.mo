within EI_CS_Modelica.cooling_system.Verification.Scenarios.Connector;
model ToConnector
  import EI_CS_Modelica.ThermoSysPro;
  ThermoSysPro.InstrumentationAndControl.Connectors.InputLogical ouvreBranche1
    annotation (Placement(transformation(origin={-142,458}, extent={{-40,-40},{
            40,40}}), iconTransformation(origin={-142,458}, extent={{-40,-40},{
            40,40}})));
