...
model Scenario0_2echangeurs_3_2
  extends Init.Scenario_init;
  Events.AddClient addClient(power = 35E6, at = 200)  annotation(
    Placement(transformation(origin = {-162, 16}, extent = {{-10, -10}, {10, 10}})));
  EI_CS_Modelica.cooling_system.Verification.Scenarios.Events.AddClient addClient1(at = 400, power = 2E6) annotation(
    Placement(transformation(origin = {-132, 16}, extent = {{-10, -10}, {10, 10}})));
  EI_CS_Modelica.cooling_system.Verification.Scenarios.Events.AddClient addClient2(at = 800, power = 2E6) annotation(
    Placement(transformation(origin = {-72, 16}, extent = {{-10, -10}, {10, 10}})));
  EI_CS_Modelica.cooling_system.Verification.Scenarios.Events.AddClient addClient3(at = 600, power = 2E6) annotation(
